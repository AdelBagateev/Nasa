...
import com.example.nasa.core.CommonStateFlow
import com.example.nasa.core.asCommonStateFlow
...
abstract class BaseViewModel<State : Any, Action, Event>(
    ...
    fun viewState(block: State.() -> State) {
        _viewState.value = viewState.block()
    }
